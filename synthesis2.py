# coding: utf-8
"""
Synthesis waveform from trained model and new speaker embedding generated from speaker_enrollment

usage: synthesis2.py [options] <checkpoint> <text_list_file> <dst_dir>
...
if __name__ == "__main__":
    ...
    if checkpoint_postnet_path is not None and checkpoint_seq2seq_path is not None:
        ...
        load_embedding_lut(model, speaker_embedding_lut)
